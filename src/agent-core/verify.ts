...
const EXPECTED_SIGNAL: Record<ToolId, string[]> = {
  ...
  "seo.pagespeed": ["mobile", "desktop"],
  "seo.schema_validate": ["blockCount", "typesFound"],
  "seo.sitemap_audit": ["totalUrls", "urls"],
  "seo.search_console": ["indexStatus", "last90Days"],
  "security.headers": ["grade", "checks"],
