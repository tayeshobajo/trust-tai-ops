...
const RISK_BY_TOOL: Record<ToolId, RiskClass> = {
  ...
  "seo.pagespeed": "read_only",
  "seo.schema_validate": "read_only",
  "seo.sitemap_audit": "read_only",
  "seo.search_console": "read_only",
  "security.headers": "read_only",
  ...
  "filesystem.list": "read_only",
  "filesystem.read": "read_only",
  "filesystem.rename": "medium_risk_change",
